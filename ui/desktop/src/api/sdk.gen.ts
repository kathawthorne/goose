...
export const updateSession = <ThrowOnError extends boolean = false>(options: Options<UpdateSessionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<UpdateSessionResponses, UpdateSessionErrors, ThrowOnError>({
        url: '/sessions/{session_id}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
